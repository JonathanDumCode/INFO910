...
class fnObj {
	...
	MD5: { (message: string | Uint8Array | number[], options: MD5.Options & { asBytes: true }): number[]; (message: string | Uint8Array | number[], options?: Pick<MD5.Options, "asString" | "encoding"> | undefined): string; (message: string | Uint8Array | number[], options?: MD5.Options | undefined): string | number[] }
